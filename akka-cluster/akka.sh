...
clusterCommand() {
  ...
  case $command in
    "start")
      $scriptPath/cluster-start.sh $argument
      ;;
    "stop")
      $scriptPath/cluster-stop.sh
      ;;
    "status")
      $scriptPath/cluster-status.sh
      ;;
    *)
      helpCluster
      ;;
...
nodeCommand() {
  ...
  case $command in
    "start")
      $scriptPath/node-start.sh $argument
      ;;
    "stop")
      $scriptPath/node-stop.sh $argument
      ;;
    "tail")
      $scriptPath/node-tail.sh $argument
      ;;
    *)
      helpNode
      ;;
